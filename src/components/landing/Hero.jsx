  ...
  return (
    <Container className="pb-16 pt-20 text-center lg:pt-32">
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
        ChatGPT Agent{' '}
        <span className="relative flex justify-center whitespace-nowrap text-center text-blue-600">
          <svg
            aria-hidden="true"
            viewBox="0 0 418 42"
            className="absolute left-0 top-2/3 h-[0.58em] fill-blue-300/70"
          ...
          <span className="relative inline-block flex-shrink-0 text-lg sm:text-4xl ">
            Trained on your company's data
          </span>
        </span>{' '}
      </h1>
